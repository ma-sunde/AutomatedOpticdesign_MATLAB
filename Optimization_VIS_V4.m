...
MaxOptTimeInSeconds = 2700;                 % Maximale Zeit eines Durchlaufes
...
StartTime = 360;                           % Dauer des ersten Durchlaufes
OptTimeInSeconds = StartTime*Faktor;      % Startzeit
Cores = 64;                               % Anzahl der CPU Kerne

TheSystem.SaveAs(System.String.Concat(FolderOutput, 'VIS_vor_globaler_Optimierung.zmx'));
...
TheSystem.SaveAs(System.String.Concat(FolderOutput, 'VIS_nach_globaler_Optimierung.zmx'));

%----------------Ausgabe----------------------------------------------------------------------------------------------------------------

file_path = fullfile(FolderVIS, 'globale_OptimierungVIS.xls');
xlswrite(file_path,Analyse);
winopen(file_path);

file_path = fullfile(FolderVIS, 'MF_globale_OptimierungVIS.xls');
